...
strays a lot from their median position, they'll pass the threshold. If they don't pass they threshold
the will not be recognized as a pollinator unless they pass the confidence threshold.
...
if __name__ == "__main__":
    ...
    [_,labels_dir,outpath,motion_thresh,motion_classes,overlap_thresh] = sys.argv[:6]
